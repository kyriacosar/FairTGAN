...
def fit_score_model(
        name, model_kwargs, train_data, test_data, continuous_cols, semsitive_column,
    ...
    for index, kwargs in enumerate(model_kwargs):
        ...
        model = TGANModel(continuous_cols, sensitive_column, output=output, **kwargs)
        ...
        score, p_rules = evaluate_classification(sampled_data, test_data, continuous_cols, sensitive_column)
...
def run_experiment(
    name, epoch, steps_per_epoch, sample_rows, train_csv, continuous_cols, sensitive_column,
    ...
    return fit_score_model(
        ...
        continuous_cols, sensitive_column, sample_rows, store_samples
    )
