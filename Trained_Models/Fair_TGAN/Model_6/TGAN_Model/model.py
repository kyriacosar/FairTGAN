...
class GraphBuilder(ModelDescBase):
    ...
    def collect_variables(self, g_scope='gen', d_scope='discrim', f_scope='fair'):
        ...
        if not (self.g_vars or self.d_vars or self.f_vars):
    ...
    def build_graph(self, *inputs):
        ...
        self.build_losses(discrim_pos, discrim_neg, fair_pred, fair_true, extra_g=KL, l2_norm=self.l2norm)
        self.collect_variables()

    def _get_optimizer(self):
        if self.optimizer == 'AdamOptimizer':
            return tf.train.AdamOptimizer(self.discrim_learning_rate, 0.5), tf.train.AdamOptimizer(self.fair_learning_rate, 0.5)
...
class TGANModel:
    ...
    def __init__(
        ...
        l2norm=0.00001, discrim_learning_rate=0.001, fair_learning_rate=0.0002, num_gen_rnn=100, num_gen_feature=100,
